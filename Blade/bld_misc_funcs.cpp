...
B_IDataFile * read_points(B_IDataFile *file, array_t *points)
{
    return NULL;
}
...
B_IDataFile& operator >>(B_IDataFile& file, point_t &point)
{
    return file;
}
...
B_IDataFile * read_sectors(B_IDataFile *file, array_t *sectors)
{
    return NULL;
}
