...
static void perform_heap_check(void);
static int heap_check_set_mark(void);
static void heap_check_all_allocations(int i);
static void heap_check_delay_free(int i);
