...
/*
* Module:                 NetBlade.dll
* Entry point:            0x10001014
*/

PLAYER_INFO *bld_get_gbl_player_info() {
        return &gbl_player_info;
}
...
/*
* Module:                 NetBlade.dll
* Entry point:            0x10001734
*/

const char *bld_get_unknown_name(int index) {
        return gbl_unknown_names[index];
}
